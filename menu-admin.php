          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="index.php?view=kategori"><i class="fa fa-circle-o"></i> Daftar Kategori</a></li>
			...
			<li class="treeview">
              ...
              <ul class="treeview-menu">
                ...
                <li><a href="index.php?view=pangkat"><i class="fa fa-circle-o"></i> Pangkat</a></li>
                <li><a href="index.php?view=pendidikan"><i class="fa fa-circle-o"></i> Pendidikan Kepolisian</a></li>
              </ul>
            </li>
            ...
            <li class="treeview">
              <a href="#"><i class="fa fa-th-large"></i> <span>Pengaturan</span><i class="fa fa-angle-left pull-right"></i></a>
              <ul class="treeview-menu">
                <li><a href="index.php?view=pengaturanstok"><i class="fa fa-circle-o"></i> Pengaturan Stok</a></li>
                <li><a href="index.php?view=pengaturanpengguna"><i class="fa fa-circle-o"></i> Pengaturan Pengguna</a></li>
              </ul>
            </li>

            <!--<li class="treeview">
              <a href="#"><i class="fa fa-user"></i> <span>Multi Menu</span><i class="fa fa-angle-left pull-right"></i></a>
              <ul class="treeview-menu">
                <li><a href="index.php?view=menu1"><i class="fa fa-circle-o"></i> Menu 1</a></li>
                <li><a href="index.php?view=menu2"><i class="fa fa-circle-o"></i> Menu 2</a></li>
                <li class="treeview">
              <a href="#"><i class="fa fa-user"></i> <span>Multi Menu</span><i class="fa fa-angle-left pull-right"></i></a>
              <ul class="treeview-menu">
                <li><a href="index.php?view=menu3"><i class="fa fa-circle-o"></i> Menu 3</a></li>
                <li><a href="index.php?view=menu4"><i class="fa fa-circle-o"></i> Menu 4</a></li>
            </li>
            </ul>
              </ul>
            </li>-->
