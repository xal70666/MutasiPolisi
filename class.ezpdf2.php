...
var $ez=array('fontSize'=>12); // used for storing most of the page configuration parameters
...
function Cezpdf($paper='A4',$orientation='portrait'){
	...
	if (!is_array($paper)){
		switch (strtoupper($paper)){
		    case 'KW': {$size = array(0,0,429.53,695.28); break;}
...
function ezTable(&$data,$cols='',$title='',$options=''){
  ...
  $defaults = array(
    'shaded'=>1,'showLines'=>1,'shadeCol'=>array(0.8,0.8,0.8),'shadeCol2'=>array(0.7,0.7,0.7),'fontSize'=>12,'titleFontSize'=>12
